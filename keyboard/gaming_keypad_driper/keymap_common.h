...
#define KEYMAP( \
   K01, K02, K03, K04, K05, K06, K07, K0B, \
   K11, K12, K13, K14, K15, K16, K17, K1B, \
   K21, K22, K23, K24, K25, K26, K27, K2B, \
   K31, K32, K33, K34, K35, \
   K48, \
   K59, \
   K6C \
) { \
    { KC_##K01, KC_##K02, KC_##K03, KC_##K04, KC_##K05, KC_##K06, KC_##K07, KC_NO,    KC_NO,    KC_NO,    KC_##K0B,   },  \
    { KC_##K11, KC_##K12, KC_##K13, KC_##K14, KC_##K15, KC_##K16, KC_##K17, KC_NO,    KC_NO,    KC_NO,    KC_##K1B,   },  \
    { KC_##K21, KC_##K22, KC_##K23, KC_##K24, KC_##K25, KC_##K26, KC_##K27, KC_NO,    KC_NO,    KC_NO,    KC_##K2B,   },  \
    { KC_##K31, KC_##K32, KC_##K33, KC_##K34, KC_##K35  },  \
    { KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_##K48 },  \
    { KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_##K59 },  \
    { KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_##K6C }  \
}
/*
#define KEYMAP( \
    ...
    { KC_NO,    KC_NO, KC_NO,    KC_##K03, KC_##K04, KC_##K05, KC_##K06, KC_##K07, KC_##K08, KC_##K09, KC_##K0A, KC_##K0B, KC_##K0C, KC_NO,    KC_NO,    KC_NO,    KC_NO   }, \
    ...
    { KC_NO,    KC_##K34, KC_NO,    KC_##K36, KC_##K37, KC_##K38, KC_##K39, KC_##K3A, KC_##K3B, KC_##K3C, KC_##K3D, KC_##K3E,    KC_##K3F, KC_NO,    KC_##K41, KC_NO,    KC_NO   }, \
    ...
    { KC_NO,    KC_##K56, KC_##K57, KC_##K58, KC_##K59,    KC_##K5A, KC_##K5B, KC_NO,    KC_##K5D, KC_##K5E, KC_##K5F, KC_##K60, KC_##K61, KC_##K62, KC_NO,    KC_NO,    KC_NO   }, \
